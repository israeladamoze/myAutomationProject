...
public class AllureAttachment {
	 ...
	 * fileExtension = ".json") public static String attachJson(String json) {
	 * return U.formatJson(json); // return U.formatJson(json); }
	 * 
	 * @Attachment(value = "XML attachment", type = "application/xml", fileExtension
	 * = ".xml") public static String attachXml(String xml) { return
	 * U.formatXml(xml);
	 * 
	 * }
	 */
